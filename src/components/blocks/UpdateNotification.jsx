...
const UpdateNotification = () => {
  const initialShouldShow = LocalStorage.get(NEEDS_UPDATE_KEY);
  ...
  const onClick = () => {
    ...
    LocalStorage.set(NEEDS_UPDATE_KEY, false);
  };
      ...
      <ButtonBase className={classes.root} onClick={onClick}>
        <div className={classes.text}>
          ...
          <Typography className={classes.subtitle}>
            Обновите страницу или нажмите на сообщение, чтобы изменения вступили в силу
          </Typography>
        </div>
